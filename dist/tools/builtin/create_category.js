...
export const registerCreateCategory = (server, ctx, opts) => {
    if (!opts.allowWrites)
    ...
    server.registerTool("discourse_create_category", {
        ...
        try {
            ...
            const data = await client.post(`/categories.json`, payload);
...
//# sourceMappingURL=create_category.js.map