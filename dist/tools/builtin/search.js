...
export const registerSearch = (server, ctx) => {
    ...
    const schema = baseSchema.refine((data) => data.query || data.category || data.author || data.after || data.before, {
        message: "At least one of query, category, author, after, or before must be provided",
    });
    server.registerTool("discourse_search", {
