...
function buildAuthorizationUrl(options, publicKey) {
...
async function saveToProfile(profilePath, site, userApiKey, clientId) {
    let profile = {};
    try {
    ...
    profile.auth_pairs = profile.auth_pairs.filter((p) => p.site !== site);
    // Add new entry
...
export async function generateUserApiKey(options) {
    if (!options.site) {
        console.error(`
...
//# sourceMappingURL=user-api-key-generator.js.map